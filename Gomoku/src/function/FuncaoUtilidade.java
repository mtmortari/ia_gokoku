...
public class FuncaoUtilidade {
	...
	public static Long calcularValorTabuleirio(Tabuleiro tab, String pecaJogador, String pecaAdversario){
		Long sum = 0L;
		sum += FuncaoUtilidade.calculaValorSequenciaSimples(tab, pecaJogador);
		sum += FuncaoUtilidade.calculaValorSequenciaDupla(tab, pecaJogador);
		sum += FuncaoUtilidade.calculaValorSequenciaTripla(tab, pecaJogador);
		sum += FuncaoUtilidade.calculaValorSequenciaQuadrupla(tab, pecaJogador);
		sum += FuncaoUtilidade.calculaValorSequenciaQuintupla(tab, pecaJogador);
		
		
		sum -= FuncaoUtilidade.calculaValorSequenciaSimples(tab, pecaAdversario);
		sum -= FuncaoUtilidade.calculaValorSequenciaDupla(tab, pecaAdversario);
		sum -= FuncaoUtilidade.calculaValorSequenciaTripla(tab, pecaAdversario);
		sum -= FuncaoUtilidade.calculaValorSequenciaQuadrupla(tab, pecaAdversario);
		sum -= FuncaoUtilidade.calculaValorSequenciaQuintupla(tab, pecaAdversario);
		return sum;
	}	
	...
	private static Long calculaValorSequenciaQuintupla(Tabuleiro tab, String pecaJogador){
		Integer size = tab.getSize();
		Long sum = 0L;
	...
	private static Boolean existeQuitupla(Tabuleiro tab, String pecaJogador){
		Integer size = tab.getSize();
